...
Die Webanwendung ist sehr verständlich und leicht zu bedienen. Der Benutzer kommt ohne Schulung gut an sein Ziel.
...
Die weiteren Hauptkriterien für die zu entwickelnde Webanwendung sind:
\begin{itemize}
...
Die eingegeben Daten seitens der Teilnehmer sollten in Echtzeit auf der Präsentation-Seite angezeigt werden.
\end{itemize}
